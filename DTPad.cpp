// DTPad.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CDTPadApp, CWinApp)
	//{{AFX_MSG_MAP(CDTPadApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CDTPadApp object

CDTPadApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CDTPadApp initialization

BOOL CDTPadApp::InitInstance()
{
...
LoadStdProfileSettings(10);  // Load standard INI file options (including MRU)
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_TEXTTYPE,
		RUNTIME_CLASS(CDTPadDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CDTPadView));
...
/////////////////////////////////////////////////////////////////////////////
// CDTPadApp message handlers


int CDTPadApp::ExitInstance() 
{
